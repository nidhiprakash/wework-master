<?php
  ...
  $sql="SELECT userdetailid from user WHERE userid='$user_id'";
  $userdetailid=mysqli_query($db,$sql)->fetch_object()->userdetailid;
 // $result=
?>
<!DOCTYPE html>
<html lang="en">
...
$sql = "SELECT firstname FROM userdetail WHERE userdetailid='$userdetailid'";
 ...
 ?>
 		...
 		<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `lastname` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `dob` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `nationality` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `gender` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
