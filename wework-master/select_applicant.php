...
<html lang="en">
  ...
  <body>
	...
	."</tr>";
		...
		$sql3 = "SELECT CONCAT (userdetail.firstname, ' ',userdetail.lastname) as Applicant_Name,
						userdetail.skills,
						job.jobid,
						jobapplicant.applicantid						
				  FROM job, jobapplicant, user, userdetail 
				 WHERE jobapplicant.actualjobid = job.jobid
				   AND user.userdetailid = userdetail.userdetailid
           AND jobapplicant.applicantid = user.userid
		           AND jobapplicant.actualjobid ='$jobid' ";
    	...
    	// output data of each row
            ...
            <div class="container bg-grey" style="margin-top: 50px; height: 250px;">
              <div class="row">
                ...
                <div class="row" style="margin-top: 10px; margin-left: 40px;"> 
                <div class="col-3">
                  <h3 style="margin-left: 900px; margin-top: -150px;"><?php echo "Applicant ID : ".$row['applicantid']; ?></h3>

          		    <br>
                  <form role="form" action="delete_job.php" method="POST">
                    <input type="hidden" value="<?php echo $row['jobid']; ?>">
          		    <button class="btn btn-common" onclick="myFunction1()" style="margin-left: 850px; margin-top: 20px; margin-bottom: 30px; width: 200px;" name="jobid" value="<?php echo $row['jobid'] ?>">Delete</button>
                </form>
                <br>
                <form role="form" action="update-applicant.php" method="POST">
                  ...
                  <button class="btn btn-common" onclick="myFunction1()" style="margin-left: 600px;  margin-top: -235px; width: 200px; color: #fec239;" name="jobid" value="<?php echo $row['jobid'] ?>">Select Applicant</button>
                </form>
                <br>
                <form role="form" action="" method="POST">
                    <input type="hidden" name="jobid" value="<?php echo $row['jobid']; ?>">
                  <button class="btn btn-common" onclick="myFunction1()" style="margin-left: 600px;  margin-top: -155px; width: 200px; color: #fec239;" name="jobid" value="<?php echo $row['jobid'] ?>">Pay</button>
                </form>
                </div>
              </div>
				...
				<td><form role="form" action="apply-to-job.php" method="POST"> 
						<input type='hidden' name='applicantid' value='<?php echo $row['applicantid']; ?>'>
                  		<button class='btn btn-common' style=' width: 60px;' name='jobid' value='<?php echo $row['jobid'] ?>'>Select</button></form></tr>
			<?php 	
    		}
