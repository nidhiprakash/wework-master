...
$sql = "SELECT firstname FROM userdetail WHERE userdetailid='$user_detail_id'";
 ...
 ?>
 		...
 		<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `lastname` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `dob` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `nationality` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `gender` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `address1` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php
$sql = "SELECT `address2` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `city` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `state` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;">
				<?php 
$sql = "SELECT `zip` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;">
				<?php 
$sql = "SELECT `skills` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;">
				<?php 
$sql = "SELECT `language` FROM `userdetail` WHERE `userdetailid`='$user_detail_id'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
