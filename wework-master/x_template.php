  ...
  <div class="container">
    <div class="row">
      <div class="col-9">
        ...
        <div class="header-content pull-left">
                   <h3><a href="#">Senior Wordpress Developer</a></h3>
      ...
      <div class="col-3">
        <h3>$35/hr</h3>
        <div><button class="btn btn-common">Apply for this Job Now</button></div>
    ...
    <div class="row">
      <div class="col-9">
        <h4>Requirements</h4>
        <br>
        <p><strong>Availibility :</strong> Hourly</p>
        <p><strong>Experience Level :</strong> Intermediate(3 to 5 years)</p>
    ...
    <div class="cd-popup contact" role="alert">
           <form name="contactform" id="contactform" class="contact-form">
             <div class="cd-popup-container" style="">
               <p style="">
                  <a href="" class="cd-popup-close cd-close-button">
                   <i class="fa fa-times" style="pointer-events:none;">Apply for this job</i>
                  </a>
               </p>
            ...
            <div class="message">
             <label for="message">Your cover letter/message sent to the employer</label>
             <textarea name="message" id="message" name="message"></textarea>
            </div>
            <br>
            <div style="text-align:left">
             <p>Upload CV/Resume</p>
             <button class="btn"><i class="fa fa-upload"></i> Browse</button>
            </div>
            <br>
            <div class="submit">
             <p class="user-message" id="blurb"> You can apply to this job and others using your online resume. Click the link below to submit your online resume and email your application to this employer.</p>
             <input type="submit" name="submit" id="submit" value="Submit Resume and Apply" />
           </div>
           </div>
          </form>
        </div>
        <div class="cd-popup notification" role="alert">
          <div class="cd-popup-container">
            ...
            <p>
            <h3 id="notification-text">Your application has been sent!</h3>
            </p>
          </div>
       </div> 
